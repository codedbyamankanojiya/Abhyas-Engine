# 📚 Abhyasa Engine Documentation

> **Comprehensive technical documentation for developers and contributors of the unified Web and Android App**
...
#### Frontend
- **React 18/19** - UI framework with hooks
- **TypeScript** - Type-safe JavaScript
- **Vite** - Build tool and dev server
- **Tailwind CSS** - Utility-first CSS framework
- **Framer Motion** - Animation library
- **Lenis** - Smooth scrolling (bypassed on touch/mobile devices)
- **React Router** - Client-side routing (`HashRouter` for WebView compatibility)
- **Capacitor** - Cross-platform wrapper for Android mobile support
...
### Community
- **GitHub Issues**: https://github.com/your-username/abhyasa-engine/issues
