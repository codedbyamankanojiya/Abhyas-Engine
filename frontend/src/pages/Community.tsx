    ...
    >
      ...
      <motion.div variants={fadeUp}>
        <GlassCard variant="blue" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Abhyas Engine is an AI-powered platform designed to <strong>revolutionize how students prepare</strong> for high-stakes skill assessments like{" "}
              <strong>viva voce examinations, job interviews,</strong> and <strong>communication training.</strong> Unlike
              conventional preparation tools, Abhyas Engine provides a fully interactive experience that simulates real-world
              evaluation scenarios using <strong>Artificial Intelligence.</strong>
            </p>
            <p>
              Through <strong>intelligent speech generation</strong> and <strong>real-time interaction,</strong> Abhyas Engine allows users to experience multiple role-play scenarios across
            ...
            <p>
              ...
              <strong>entry-level interviews</strong>. Abhyas Engine is here to bridge that gap. It works as a <strong>holistic confidence-building tool</strong> that adapts to the user's
      ...
      <motion.div variants={fadeUp}>
        <GlassCard variant="default" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Abhyas Engine provides an <strong>AI-powered environment</strong> where users can practice <strong>real-time interviews</strong> and simulations in a{" "}
      ...
      <motion.div variants={fadeUp}>
        <GlassCard variant="purple" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Abhyas Engine is built with a deep focus on <strong>practical interview readiness,</strong> not just theoretical knowledge-sharing platforms. It provides{" "}
            ...
            <p>
              Abhyas Engine also provides a <strong>structured</strong> and <strong>guided experience.</strong> Users are not left without clear advice on what to study or how to
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
            <StatBadge icon={Star} label="Tester Rating" value="4.9/5" />
            <StatBadge icon={Users} label="Beta Testers" value="10+" />
            <StatBadge icon={Zap} label="Test Sessions" value="500+" />
          </div>
        </GlassCard>
      </motion.div>
      ...
      <motion.div variants={fadeUp}>
        <GlassCard variant="default" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm text-gray-700 leading-relaxed">
            <p>
              Abhyas Engine goes beyond traditional learning platforms by focusing on <strong>real-time behavioral analysis</strong> rather than passive learning. Unlike other platforms
              that focus on video lectures or static question banks, Abhyas Engine provides a <strong>dynamic, responsive, and personalized experience.</strong>
            </p>
            <p>
        ...
        <GlassCard variant="blue" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm text-gray-700 leading-relaxed">
            ...
            <p>
              ...
              resources they have. Abhyas Engine levels the playing field by providing <strong>intelligent, personalized coaching</strong> that was previously only available to those
        ...
        <GlassCard variant="purple" className="p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-2">
            {[
              ...
              { q: "Do I need prior knowledge to start?", a: "Not at all! Abhyas Engine adapts to your level, from beginner to advanced." },
              { q: "Is this different from other platforms?", a: "Yes. Unlike static question banks and boring prep tools, Abhyas Engine provides real-time, AI-powered interactive practice sessions." },
              { q: "Does it help improve communication skills?", a: "Absolutely! Abhyas Engine provides detailed feedback on clarity, confidence, articulation, and overall speech quality." },
